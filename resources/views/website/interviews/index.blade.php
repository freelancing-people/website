...
@section('meta')
    ...
    <meta property="og:image" content="https://freelancingpeople.com/images/freelancing-people-shareable.png">
    ...
    <meta name="twitter:image" content="https://freelancingpeople.com/images/freelancing-people-shareable.png">
                        ...
                        <div class="col-sm-4">
                            <div class="photo-grid triangle-border">
                                <a href="/interviews/{{ $interview->slug }}">
                                    <img src="https://res.cloudinary.com/doohrbhlh/image/fetch/{{ Storage::disk('public')->url($interview->avatar) }}" alt="{{ $interview->name }}">
