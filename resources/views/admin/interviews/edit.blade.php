                        ...
                        <form action="/admin/interviews/{{ $interview->slug }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group @if($errors->has('shareable_description')) has-error @endif">
                                        ...
                                        <textarea name="shareable_description" id="shareable_description" class="form-control" rows="5">{{ $interview->shareable_description }}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group @if($errors->has('website')) has-error @endif">
                                        ...
                                        <input type="text" class="form-control" name="website" id="website" value="{{ $interview->website }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="published" value="1" checked="checked"> Published?
                                        </label>
